# Generated by Powerlevel10k configuration wizard on 2023-06-23 at 23:51 CEST.
...
() {
  ...
  p10k-on-pre-prompt()  p10k display '*/right'=show
  p10k-on-post-prompt() p10k display '*/right'=hide
